...
// Script registration for the shader types in `draw` happens through the
// crate-level [`crate::script_mod`] — call that from `AppMain::script_mod`
// (after `makepad_widgets::script_mod`) before using these primitives.
